            ...
            <div className="space-y-5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.password ? "border-red-500" : "border-gray-300"
                    } focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all`}
                />
                {errors.password && (
              ...
              {formData.role === "student" && (
                <div className="relative">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className={`w-full pl-10 pr-4 py-3 rounded-lg border ${errors.selectedRoute
                        ? "border-red-500"
                        : "border-gray-300"
                  ...
                  >
                    ...
                    {routes.map((route) => (
                      <option key={route._id} value={route._id}>
                        {`${route.startLocation.name} → ${route.endLocation.name} | Bus: ${route.assignedBus?.busNumber ?? "No bus assigned"
                          }`}
                      </option>
                    ))}
                  </select>
