  ...
  useEffect(() => {
    if (driverInfo && busInfo && routeInfo) {
      ...
      newSocket.on("connect", () => {
        ...
        newSocket.emit("authenticate", { userId: driverInfo._id });
      });
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex flex-col">
      ...
      <main className="flex-1 px-6 py-6">
        <div className="max-w-6xl mx-auto space-y-6">
          ...
          {lastUpdateMessage && (
            <div
              className={`flex items-center gap-2 px-4 py-3 rounded-xl ring-1 ${
                lastUpdateMessage.includes("✅")
                  ...
                  {routeInfo.stops.map((stop, index) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-full group text-left flex items-center gap-4 p-3 rounded-xl ring-1 transition ${
                          isDone
                      ...
                      >
                        <span className={`shrink-0 h-3 w-3 rounded-full ring-4 ${
                          isDone
